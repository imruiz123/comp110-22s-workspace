...
class Point:
    ...
    def __init__(self, x: float, y: float):
        """Initalize a Point with its x, y componets."""
        self.x = x
        self.y = y 

    def scale_by(self, factor: float) -> None:
        """Mutates: multiples compnets by factor."""
        self.x *= factor 
        self.y *= factor 

    def scale(self, factor: float) -> Point:
        """Immutable: multiplies componet by factor."""
    ...
    def __repr__(self) -> str:
        """Produce a str represeation of a Point for Python!"""
